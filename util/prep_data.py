...
train_dir = '/Users/hannahrae/data/dan/train_full'
test_dir = '/Users/hannahrae/data/dan/test_full'
...
for meas in train:
    ...
    # We only use the subset of bins most discriminative for H2O and Cl
    ...
    np.save(train_dir + '/' + meas + '.npy', feature_vec)
